...
<body>
            ...
            <nav
              ...
              <div class="navbar-collapse">
                <ul class="nav navbar-nav navbar-center">
                  ...
                  <li><a href="" class="btn btn-default navbar-btn">공지사항</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          <h1>SSong Class</h1>
          <br>
          <p style= "font-size:20px; font-family:'배달의민족 도현'";>공지사항</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <!-- 컨트롤러로 보내는것 -->
  <!-- boardcontroller get방식으로 이동 -->
  <hr>
  * 공지사항 게시판 글 작성은 관리자만 가능합니다.
    ...
    <tbody>
      <c:forEach var="vo" items="${list }">
        <tr>
          <td>${vo.noticeNo }</td>
          <td><a
            href="detail?noticeNo=${vo.noticeNo }&page=${pageMaker.criteria.page}">${vo.noticeTitle }</a></td>
          <td>admin</td>
